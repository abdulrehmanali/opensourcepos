...
<div class="row">
	<div class="col-md-6 col-lg-4 mb-3">
		<div class="card bg-primary">
			<div class="card-header text-light icon-link">
				<i class="bi-bar-chart"></i><?= lang('Reports.graphical_reports'); ?>
			</div>
	...
	<div class="col-md-6 col-lg-4 mb-3">
		<div class="card bg-primary">
			<div class="card-header text-light icon-link">
				<i class="bi-card-list"></i><?= lang('Reports.summary_reports'); ?>
			</div>
			<div class="list-group list-group-flush">
				<?php foreach ($permission_ids as $permission_id) {
					if (can_show_report($permission_id, ['inventory', 'receiving'])) {
	...
	<div class="col-md-6 col-lg-4 mb-3">
		<div class="card bg-primary mb-3">
			<div class="card-header text-light icon-link">
				<i class="bi-card-checklist"></i><?= lang('Reports.detailed_reports') ?>
			</div>
			<div class="list-group list-group-flush">
		...
		<?php if (in_array('reports_inventory', $permission_ids, true)) { ?>
			<div class="card bg-primary">
				<div class="card-header text-light icon-link">
					<i class="bi-box"></i><?= lang('Reports.inventory_reports') ?>
				</div>
				<div class="list-group list-group-flush">
					<?php
