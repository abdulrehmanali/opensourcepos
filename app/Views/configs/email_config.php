...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-mailbox"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-braces"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-database"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-door-open"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-shield-lock"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-stopwatch"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-person"></i></label>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-lock"></i></label>
