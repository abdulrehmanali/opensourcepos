...
<div class="row">
	<div class="col-12 col-lg-6">
		<label for="info-company" class="form-label"><?= lang('Config.company'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-shop-window"></i></span>
	...
	<div class="col-12 col-lg-6">
		<div id="info-company_logo" class="w-100 fileinput <?= $logo_exists ? 'fileinput-exists' : 'fileinput-new'; ?>" data-provides="fileinput">
			<div class="input-group mb-3" aria-describedby="company-logo-desc">
				<span class="input-group-text"><i class="bi-image"></i></span>
			...
			<div type="button" class="btn btn-secondary btn-file me-2">
				<span class="fileinput-new icon-link"><i class="bi-hand-index pe-1"></i><?= lang('Config.company_select_image') ?></span>
				<span class="fileinput-exists icon-link"><i class="bi-images pe-1"></i><?= lang('Config.company_change_image') ?></span>
				<input type="file" name="company_logo">
			</div>
			<button type="button" class="btn btn-outline-secondary icon-link fileinput-exists" data-dismiss="fileinput">
				<i class="bi-eraser pe-1"></i><?= lang('Config.company_remove_image') ?>
			</button>
		</div>
	</div>
...
<label for="info-address" class="form-label"><?= lang('Config.address'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
<div class="input-group mb-3">
...
<div class="row">
	...
	<div class="col-12 col-lg-6">
		<label for="info-phone" class="form-label"><?= lang('Config.phone'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-printer"></i></span>
			<input type="tel" class="form-control" name="fax" id="info-fax" value="<?= $config['fax']; ?>">
		</div>
	</div>
</div>

<label for="info-return_policy" class="form-label"><?= lang('Common.return_policy'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
<div class="input-group mb-3">
	<span class="input-group-text"><i class="bi-box-arrow-in-down-left"></i></span>
