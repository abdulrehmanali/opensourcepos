...
<div class="input-group mb-3">
	<span class="input-group-text"><i class="bi-file-text"></i></span>
...
<div class="input-group mb-3">
	<span class="input-group-text"><i class="bi-envelope-paper"></i></span>
...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-list-ol"></i></span>
