...
<div class="row">
	<div class="col-12 col-sm-6 col-xxl-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-globe-americas"></i></span>
	...
	<div class="col-12 col-sm-6 col-xxl-3">
		...
		<div class="mb-3" id="number_locale_example">
			...
			<a href="https://github.com/opensourcepos/opensourcepos/wiki/Localisation-support" target="_blank" rel="noopener">
				<i class="bi-link-45deg link-secondary" data-bs-toggle="tooltip" title="<?= lang('Config.number_locale_tooltip'); ?>"></i>
			</a>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col-12 col-sm-6 col-xxl-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-currency-exchange"></i></span>
...
<div class="row">
	<div class="col-12 col-sm-6 col-xxl-3">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-coin"></i></label>
	...
	<div class="col-12 col-sm-6 col-xxl-3">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-archive"></i></label>
	...
	<div class="col-12 col-sm-6 col-xxl-3">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-123"></i></label>
	...
	<div class="col-12 col-sm-6 col-xxl-3">
		<label for="cash_decimals" class="form-label"><?= lang('Config.cash_decimals') ?>
			<i class="bi-info-circle-fill text-secondary" data-bs-toggle="tooltip" title="<?= lang('Config.cash_decimals_tooltip'); ?>"></i>
		</label>
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-cash-coin"></i></label>
	...
	<div class="col-12 col-sm-6 col-xxl-3">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-arrow-repeat"></i></label>
...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-credit-card"></i></label>
	...
	<div class="col-12 col-lg-6">
		<label for="country_codes" class="form-label">
			...
			<a href="https://wiki.openstreetmap.org/wiki/Nominatim/Country_Codes" target="_blank" rel="noopener">
				<i class="bi-link-45deg text-secondary" data-bs-toggle="tooltip" title="<?= lang('Config.country_codes_tooltip'); ?>"></i>
			</a>
		</label>
		<div class="input-group mb-3">
...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-translate"></i></label>
			<?= form_dropdown(
				'language',
				get_languages(),
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-clock"></i></label>
			<?= form_dropdown(
				'timezone',
				get_timezones(),
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-calendar2"></i></label>
			<?= form_dropdown(
				'dateformat',
				get_dateformats(),
				$config['dateformat'],
...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-calendar2-month"></i></label>
