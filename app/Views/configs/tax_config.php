...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-bank"></i></span>
...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-1-square"></i></label>
			...
			<label class="input-group-text"><i class="bi-percent"></i></label>
		</div>
	</div>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<label class="input-group-text"><i class="bi-2-square"></i></label>
...
<div class="row">
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-bookmark"></i></span>
