...
<div class="row">
	<div class="col-12 col-sm-6 col-xxl-3">
		<label for="default_sales_discount" class="form-label"><?= lang('Config.default_sales_discount') ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-cart-dash"></i></span>
	...
	<div class="col-12 col-sm-6 col-xxl-3">
		<label for="default_receivings_discount" class="form-label"><?= lang('Config.default_receivings_discount') ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-bag-dash"></i></span>
...
<div class="row">
	<div class="col-12 col-sm-6 col-xxl-3">
		<label for="lines_per_page" class="form-label"><?= lang('Config.lines_per_page'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
...
<div class="form-check form-switch mb-3">
	...
	<div class="form-text"><i class="bi-info-square"></i>&nbsp;<?= lang('Config.enforce_privacy_tooltip') ?></div>
</div>
...
<div class="row">
	...
	<div class="col-12 col-sm-6 col-xl-3">
		<div class="input-group mb-3" data-bs-toggle="tooltip" title="<?= lang('Config.image_max_width_tooltip'); ?>">
			<span class="input-group-text"><i class="bi-arrow-left-right"></i></span>
	...
	<div class="col-12 col-sm-6 col-xl-3">
		<div class="input-group mb-3" data-bs-toggle="tooltip" title="<?= lang('Config.image_max_height_tooltip'); ?>">
			<span class="input-group-text"><i class="bi-arrow-down-up"></i></span>
	...
	<div class="col-12 col-sm-6 col-xl-3">
		<div class="input-group mb-3" data-bs-toggle="tooltip" title="<?= lang('Config.image_max_size_tooltip'); ?>">
			<span class="input-group-text"><i class="bi-hdd"></i></span>
	...
	<div class="col-12 col-sm-6 col-xl-3">
		<div class="input-group mb-3" data-bs-toggle="tooltip" title="<?= lang('Config.image_allowed_file_types'); ?>">
			<label class="input-group-text"><i class="bi-images"></i></label>
...
<div class="form-check form-switch mb-3">
	...
	<a class="d-inline-block" href="https://google.com/recaptcha/admin" target="_blank" rel="noopener"><i class="bi-link-45deg link-secondary"></i></a>
	<div class="form-text"><i class="bi-info-square"></i>&nbsp;<?= lang('Config.gcaptcha_tooltip') ?></div>
</div>
...
<div class="row" id="suggestions_layout">
	...
	<div class="col-12 col-sm-6 col-xl-4 col-xxl-3 mb-3">
		<div class="input-group">
			<label class="input-group-text"><i class="bi-layout-three-columns"></i>&nbsp;1.</label>
	...
	<div class="col-12 col-sm-6 col-xl-4 col-xxl-3 mb-3">
		<div class="input-group">
			<label class="input-group-text"><i class="bi-layout-three-columns"></i>&nbsp;2.</label>
	...
	<div class="col-12 col-sm-6 col-xl-4 col-xxl-3 mb-3">
		<div class="input-group">
			<label class="input-group-text"><i class="bi-layout-three-columns"></i>&nbsp;3.</label>
...
<div class="form-check form-switch mb-3">
	...
	<div class="form-text"><i class="bi-info-square"></i>&nbsp;<?= lang('Config.derive_sale_quantity_tooltip') ?></div>
</div>
