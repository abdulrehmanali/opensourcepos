...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-file-code"></i></span>
	...
	<div class="col-6 col-lg-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-stopwatch"></i></span>
...
<div class="row">
	<div class="col-6 col-lg-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrow-bar-down"></i></span>
	...
	<div class="col-6 col-lg-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrow-bar-right"></i></span>
	...
	<div class="col-6 col-lg-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrow-bar-up"></i></span>
	...
	<div class="col-6 col-lg-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrow-bar-left"></i></span>
