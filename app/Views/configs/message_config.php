...
<div class="row">
	<div class="col-12 col-lg-6 mb-3">
		<label for="msg-uid" class="form-label"><?= lang('Config.msg_uid'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group">
			<span class="input-group-text" id="msg-uid-icon"><i class="bi-person"></i></span>
			<input type="text" class="form-control" id="msg-uid" aria-describedby="msg-uid-icon" required value="<?= $config['msg_uid']; ?>">
		</div>
	</div>

	<div class="col-12 col-lg-6 mb-3">
		<label for="msg-pwd" class="form-label"><?= lang('Config.msg_pwd'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group">
			<span class="input-group-text" id="msg-pwd-icon"><i class="bi-lock"></i></span>
			<input type="password" class="form-control" id="msg-pwd" aria-describedby="msg-pwd-icon" required value="<?= $config['msg_pwd']; ?>">
		</div>
	</div>

	<div class="col-12 col-lg-6 mb-3">
		<label for="msg-src" class="form-label"><?= lang('Config.msg_src'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group">
			<span class="input-group-text" id="msg-src-icon"><i class="bi-megaphone"></i></span>
...
<div class="input-group mb-3">
	<span class="input-group-text"><i class="bi-chat-quote"></i></span>
