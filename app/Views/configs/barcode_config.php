...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-braces"></i></span>
	...
	<div class="col-6 col-lg-3">
		<label for="barcode_width" class="form-label"><?= lang('Config.barcode_width'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrows"></i></span>
	...
	<div class="col-6 col-lg-3">
		<label for="barcode_height" class="form-label"><?= lang('Config.barcode_height'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrows-vertical"></i></span>
...
<div class="row">
	<div class="col-6 col-lg-3">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-fonts"></i></span>
	...
	<div class="col-6 col-lg-3">
		<label for="barcode_font_size" class="form-label">Font Size<sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrows-angle-expand"></i></span>
...
<div class="form-check form-switch mb-3">
	...
	<div class="form-text"><i class="bi-info-square"></i>&nbsp;<?= lang('Config.barcode_tooltip') ?></div>
</div>
...
<div class="row">
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-code-square"></i></span>
			<!-- <?php
...
<div class="row">
	...
	<div class="col-6 col-lg-3">
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-1-square"></i></span>
	...
	<div class="col-6 col-lg-3">
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-2-square"></i></span>
	...
	<div class="col-6 col-lg-3">
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-3-square"></i></span>
...
<div class="row">
	<div class="col-6 col-lg-3">
		<label for="barcode_num_in_row" class="form-label"><?= lang('Config.barcode_number_in_row'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
	...
	<div class="col-6 col-lg-3">
		<label for="barcode_page_width" class="form-label"><?= lang('Config.barcode_page_width'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-arrows"></i></span>
			...
			<span class="input-group-text"><i class="bi-percent"></i></span>
		</div>
	</div>

	<div class="col-6 col-lg-3">
		<label for="barcode_page_cellspacing" class="form-label"><?= lang('Config.barcode_page_cellspacing'); ?><sup><span class="badge text-primary"><i class="bi-asterisk"></i></span></sup></label>
		<div class="input-group mb-3">
			<span class="input-group-text"><i class="bi-distribute-horizontal"></i></span>
