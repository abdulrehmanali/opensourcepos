...
<div class="row">
	<div class="col-12 col-lg-6">
		<label for="mailchimp_api_key" class="form-label">
			...
			<!--<a href="https://eepurl.com/dyijVH" target="_blank" rel="noopener">
				<i class="bi-info-circle-fill text-secondary" data-bs-toggle="tooltip" title="<?= lang('Config.mailchimp_tooltip'); ?>"></i>
			</a>-->
		</label>
		<div class="input-group">
			<span class="input-group-text" id="mailchimp-api-key-icon"><i class="bi-key"></i></span>
		...
		<div class="form-text mb-3">
			<a class="link-secondary icon-link" href="https://eepurl.com/dyijVH" target="_blank" rel="noopener">
				<i class="bi-info-square"></i><?= lang('Config.mailchimp_tooltip') ?>
			</a>
		</div>
	</div>
	...
	<div class="col-12 col-lg-6">
		...
		<div class="input-group mb-3">
			<span class="input-group-text" id="mailchimp-lists-icon"><i class="bi-person-lines-fill"></i></span>
