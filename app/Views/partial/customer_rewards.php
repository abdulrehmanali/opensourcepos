...
<span class="d-flex justify-content-start add_customer_reward">
	<button class="btn btn-outline-success mb-3" type="button"><i class="bi-plus-lg"></i>&nbsp;Add reward</button> <!-- TODO-BS5 translate -->
</span>
...
<div class="col-12 col-lg-6 <?= $reward_category['deleted'] ? 'd-none' : '' ?>">
	...
	<div class="input-group mb-3">
		...
		<button class="btn btn-outline-danger remove_customer_reward" type="button"><i class="bi-x-lg"></i></button>
	</div>
</div>
